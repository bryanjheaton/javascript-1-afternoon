...
function greeting(name) {//Code Here
  return "Hello, " + name;
}
...
let newGreeting = function(name) {//Code Here
  return "Hello, " + name;
}
//////////////////PROBLEM 3////////////////////
...
function doubleCheck(groceries) {//Code Here
...
function looper(myArray) {
  ...
  for (let i = 0; i < myArray.length; i++) {
    if(myArray[i] >= 100 || myArray[i] % 2 === 1) {
      mySum = myArray[i] + mySum;
    }
  }
return mySum;
}
...
let mathSum = math(3, 4, add)//Code Here
